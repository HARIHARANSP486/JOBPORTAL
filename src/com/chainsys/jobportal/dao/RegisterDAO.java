...
public class RegisterDAO {
	/*
	 * addUser method is used to registering the new user.
	 */
	...
	/*
	 * checkLogin method is used to check the login credentials.
	 */
	...
	/*
	 * change password method is used to reset password user password or
